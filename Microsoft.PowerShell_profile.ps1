...
function Update-Profile {
    ...
    try {
        $url = "https://raw.githubusercontent.com/MashoodBilal/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
...
function ls { Get-ChildItem $pwd -File }
function ll { Get-ChildItem $pwd  }
function uptime {
